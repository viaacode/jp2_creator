...
def main():
    ...
    parser.add_argument('username', help='the routing key to use when posting the result', type=str)
    parser.add_argument('password', help='the routing key to use when posting the result', type=str)
